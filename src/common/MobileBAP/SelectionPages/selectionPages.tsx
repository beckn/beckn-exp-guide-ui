  ...
  return (
    <div className="selectionPage_wrapper">
      ...
      <div className="selectionPage_wrapper_innr">
        <a
          href={`https://retail-app-french-infra.becknprotocol.io/??external_url=${orderObjectUrl}`}
          target=""
        ...
        <a
          href={`https://mobility-app-french-infra.becknprotocol.io??external_url=${orderObjectUrl}`}
          target=""
          rel="noopener noreferrer"
        >
          <div className="Link_wrapper">
